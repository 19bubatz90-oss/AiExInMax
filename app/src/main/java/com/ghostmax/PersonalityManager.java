...
public class PersonalityManager {
    ...
    public static List<Personality> getDefaultPersonalities() {
        ...
        list.add(new Personality("Philosophischer Denker","Tiefgründig, reflektierend","Du bist ein weiser Philosoph.","Gemini",1.0,1024,"🧠"));
        ...
        list.add(new Personality("Sprachkünstler & Übersetzer","Mehrsprachig, stilistisch","Du hilfst bei Formulierungen und Übersetzungen.","Gemini",0.5,1024,"📝"));
