...
public class CustomProvider {
    ...
    public CustomProvider(String name, String baseUrl, String apiKey, String model, String category) {
        this.name = name; this.baseUrl = baseUrl; this.apiKey = apiKey;
        this.model = model; this.category = category == null ? CATEGORY_CHAT : category;
    }
    public boolean isImageProvider() { return CATEGORY_IMAGE.equals(category); }
    public JSONObject toJson() throws JSONException {
        JSONObject o = new JSONObject();
        o.put("name", name); o.put("baseUrl", baseUrl);
        o.put("apiKey", apiKey == null ? "" : apiKey);
        o.put("model", model); o.put("category", category);
        return o;
    }
